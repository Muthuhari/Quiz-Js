...
let q1=new Question(1,'Question 1',[new Answer(1,'Answer 1',false),new Answer(2,'Answer 2',true),new Answer(3,'Answer 3',false)]);
let q2=new Question(2,'Question 2',[new Answer(1,'Answer 1',true),new Answer(2,'Answer 2',false),new Answer(3,'Answer 3',false)]);
let q3=new Question(3,'Question 3',[new Answer(1,'Answer 1',true),new Answer(2,'Answer 2',false),new Answer(3,'Answer 3',false)]);
let q4=new Question(4,'Question 4',[new Answer(1,'Answer 1',false),new Answer(2,'Answer 2',false),new Answer(3,'Answer 3',true)]);
let q5=new Question(5,'Question 5',[new Answer(1,'Answer 1',true),new Answer(2,'Answer 2',false),new Answer(3,'Answer 3',false)]);
